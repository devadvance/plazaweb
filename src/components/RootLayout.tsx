    ...
    <Container>
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-x-8">
          <Button href="/visit" invert={invert}>
            Visit now
          </Button>
          <button
            ref={toggleRef}
            ...
            className={clsx(
              ...
              invert ? 'hover:bg-white/10' : 'hover:bg-green-950/10',
            )}
...
function NavigationRow({ children }: { children: React.ReactNode }) {
  return (
    <div className="even:mt-px sm:bg-green-950">
      <Container>
...
function NavigationItem({
  ...
  return (
    <Link
      href={href}
      className="group relative isolate -mx-6 bg-green-950 px-6 py-10 even:mt-px sm:mx-0 sm:px-0 sm:py-16 sm:odd:pr-16 sm:even:mt-0 sm:even:border-l sm:even:border-neutral-800 sm:even:pl-16"
    >
      {children}
    ...
    >
      <header>
        ...
        <motion.div
          ...
          className="relative z-50 overflow-hidden bg-green-950 pt-2"
          aria-hidden={expanded ? undefined : 'true'}
          // @ts-ignore (https://github.com/facebook/react/issues/17157)
          inert={expanded ? undefined : ''}
        >
          <motion.div layout className="bg-neutral-800">
            <div ref={navRef} className="bg-green-950 pt-14 pb-16">
              <Header
                invert
                panelId={panelId}
                icon={XIcon}
